...
public final class SecretsOfStrixhavenCommander extends ExpansionSet {
    ...
    private static final List<String> unfinished = Arrays.asList("Defacing Duskmage", "Dirgur Focusmage", "Eccentric Pestfinder", "Eiganjo Dynastorian", "Inspired Skypainter", "Stensian Sanguinist", "Striding Shotcaller", "Yavimaya Bloomsage");
