...
CARD_TABLE = {
    ...
    "shimmercreep.txt": (P, "DB", "ETB_TRIGGER_X", "", "", "bf=Elite Vanguard:1,Grizzly Bears:1", 3, -3,
        "true colors among own permanents incl. self (W,G,B) so X=3; lands are colorless"),
    ...
    "vraska_betrayals_sting.txt": (P, "AB", "PLANESWALKER_DRAW_LOSE", "", "B2C4", "library_fill=2", -1, 0,
        "real cast (4BB/P, B/P paid as B, no life) initializes loyalty via ETB; then Draw AB"),
