...
Verifies the queue item (WS33D/template-059/STATE_ONLY/LifeGainEffect),
...
def main() -> int:
    ...
    print(f"WS33_ABC_D1_FILTER=PASS cases=10 deferred=12 digest={digest}")
    return 0
