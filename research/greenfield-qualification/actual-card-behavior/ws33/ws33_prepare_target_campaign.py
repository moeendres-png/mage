...
SUPPORTED = {
    ...
    "Enchantment": "OPPONENT_ENCHANTMENT",
    "Land": "OPPONENT_LAND",
    "Land.YouCtrl": "OWN_LAND",
    "Land.nonBasic": "OPPONENT_NONBASIC_LAND",
    "Artifact.nonCreature": "OPPONENT_ARTIFACT",
    "Artifact.nonCreature+YouCtrl": "OWN_ARTIFACT",
    "Artifact.OppCtrl,Enchantment.OppCtrl": "OPPONENT_ARTIFACT",
    "Artifact.Other": "OPPONENT_ARTIFACT",
    "Creature,Vehicle": "OPPONENT_CREATURE",
    "Instant.YouCtrl": "OWN_INSTANT",
    "Artifact.YouCtrl,Creature.YouCtrl,Land.YouCtrl": "OWN_ARTIFACT",
    "Instant": "OPPONENT_INSTANT",
    "Artifact.YouDontCtrl": "OPPONENT_ARTIFACT",
    "Elemental.Other+YouCtrl": "OWN_ELEMENTAL",
    "Artifact,Creature,Enchantment,Land": "OPPONENT_ARTIFACT",
    "Artifact,Creature,Planeswalker": "OPPONENT_ARTIFACT",
    "Artifact,Enchantment,Land": "OPPONENT_ARTIFACT",
    "Artifact,Enchantment,Planeswalker": "OPPONENT_ARTIFACT",
    "Artifact.YouOwn": "OWN_ARTIFACT",
    "Card.nonLand+YouOwn": "OWN_ARTIFACT",
    "Card.OppCtrl": "OPPONENT_CREATURE",
    "Creature.YouDontCtrl": "OPPONENT_CREATURE",
    "Creature.YouCtrl+Other": "OWN_CREATURE",
    "Creature.nonBlack+nonArtifact": "OPPONENT_CREATURE",
    "Creature.nonArtifact+OppCtrl": "OPPONENT_CREATURE",
    "Permanent.Other": "OPPONENT_CREATURE",
    "Permanent.OppCtrl+nonLand": "OPPONENT_CREATURE",
    "Permanent.nonWhite": "OPPONENT_CREATURE",
    "Permanent.nonLand+YouOwn": "OWN_CREATURE",
    "Permanent.nonLand+YouCtrl": "OWN_CREATURE",
}
def load(path: Path):
