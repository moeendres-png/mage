...
CARD_TABLE = {
    ...
    ("gideon_jura.txt", 11): (P, "ANIMATE_PREVENTION", "fixture_spell=Seismic Rupture", "R1C2",
        "", 0, 0,
        "0-loyalty animate (no targets/decisions); fixture Seismic prevented, loyalty stays 6"),
