...
* test-side SpellAbility target injection -> PlayerController.chooseTargetsFor using
  TargetRestrictions#getAllCandidates as the authoritative legal-option source.
...
def main() -> None:
    ...
    print("WS33_H_REST_HARNESS_PREP=PASS direct_resolution=0 manual_test_target_injection=0 target_source=TargetRestrictions#getAllCandidates replay_mode=TAPE_DRIVEN")
