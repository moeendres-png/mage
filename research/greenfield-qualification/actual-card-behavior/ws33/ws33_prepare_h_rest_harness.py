...
def main() -> None:
    ...
    require("\\\"decision_id\\\"" in s and "\\\"game_id\\\"" in s, "ABI V2.1 decision identity fields missing")
    require("\\\"authoritative_legal_options\\\"" in s and "\\\"response_option_ids\\\"" in s, "ABI V2.1 authoritative decision shape missing")

    args.out.write_text(s, encoding="utf-8")
    print("WS33_H_REST_HARNESS_PREP=PASS direct_resolution=0 manual_test_target_injection=0 target_source=TargetRestrictions#getAllCandidates replay_mode=TAPE_DRIVEN combat_constraint_trace=CANONICAL_FORGE_STATE decision_evidence=ABI_V2_1")
